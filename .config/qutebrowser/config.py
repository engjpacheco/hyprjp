...
c.url.default_page = 'https://jpstart.netlify.app/'
c.url.start_pages = 'https://jpstart.netlify.app/'
...
config.bind(
    'M', 'hint links spawn nohup mpv --fs --cache=yes --demuxer-max-bytes=500M --demuxer-max-back-bytes=100M --save-position-on-quit=no -ytdl-format="bv*[height=720][ext=mp4][fps=30]+ba/b" {hint-url}')
